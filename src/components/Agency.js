    ...
    <div name="agency" className='w-full h-full relative'>
        ...
        <div className='absolute w-full h-full top-0 left-0 flex flex-col justify-center text-center'>
          <div className='flex flex-col'>
            ...
            <p><span className='font-bold text-[var(--secondary)]'>TRAVEL</span> is a premier tour company dedicated to providing exceptional travel experiences to adventurous individuals and families. With a passion for exploration and a commitment to creating unforgettable memories, we offer a wide range of meticulously crafted tours and itineraries to some of the most <Link to="home" className='cursor-pointer text-[var(--primary)] italic'>captivating destinations</Link> around the globe.</p>
            </div>
            <div className='flex justify-center'>
               <button onClick={() => window.scrollTo(0, 0)} className='px-6 py-4 flex items-center font-semibold text-2xl rounded'><span><BsCamera2 size={30} className="text-[#000] mr-5 animate-pulse"/></span>More...</button>
            </div>
          </div>
        </div>
    </div>
