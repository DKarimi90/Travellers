...
const Places = () => {
  return (
    <div name="places" className='w-full h-full'>
        <div className='flex flex-col w-full h-full max-w-[1240px] mx-auto justify-center items-center my-32'>
            ...
            <div className='w-full grid md:grid-cols-2 gap-2 ml-3'>
              <div className=' flex flex-col bg-slate-200 overflow-hidden rounded-sm'>
                ...
                <div className='flex justify-between mt-4 px-5 p-1'>
                  <div>
                    <h2 className='font-bold text-3xl'>Balkan</h2>
                    <p>Soča valley</p>
                  </div>
                <div>
              ...
              <div className=' flex flex-col bg-slate-200 overflow-hidden rounded-sm'>
                ...
                <div className='flex justify-between mt-4 px-5 p-1'>
                  <div>
                    <h2 className='font-bold text-3xl'>France</h2>
                    <p>Eiffel Tower</p>
                  </div>
                <div>
              ...
              <div className=' flex flex-col bg-slate-200 overflow-hidden rounded-sm'>
                ...
                <div className='flex justify-between mt-4 px-5 p-1'>
                  <div>
                    <h2 className='font-bold text-3xl'>Thailand</h2>
                    <p>Phuket</p>
                  </div>
                <div>
              ...
              <div className=' flex flex-col bg-slate-200 overflow-hidden rounded-sm'>
                ...
                <div className='flex justify-between mt-4 px-5 p-1'>
                  <div>
                    <h2 className='font-bold text-3xl'>Malaysia</h2>
                    <p>Penang</p>
                  </div>
                <div>
            ...
            <div className='my-10'>
              <button className='p-4 rounded font-semibold'>Explore More Places</button>
            </div>
        </div>
    </div>
  )
